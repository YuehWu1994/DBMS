...
RC privateTestCase_2() {
	...
	*(int *) value2.data = compVal;
	...
	// while(is->getNextTuple(data2) != QE_EOF){
	// 	mycount++;
	// 	offset = 0;
	// 	int A;
	// 	if((*(unsigned char *)((char *)data2 + offset) & (1 << 7)) == 0)
	// 	{
	// 		memcpy(&A, (char *)data2 + sizeof(char)+offset, sizeof(int));
	// 		cout << "left2.A " << A << " ";

	// 	}
	// 	offset += sizeof(int);
	// 	int B;
	// 	if((*(unsigned char *)((char *)data2 + offset) & (1 << 6)) == 0)
	// 	{
	// 		memcpy(&B, (char *)data2 + sizeof(char) + offset, sizeof(int));
	// 		cout << "left2.B " << B << " ";
	// 	}
	// 	offset += sizeof(int);
	// 	float C;
	// 	if((*(unsigned char *)((char *)data2 + offset) & (1 << 5)) == 0)
	// 	{
	// 		memcpy(&C, (char *)data2 + sizeof(char) + offset, sizeof(int));
	// 		cout << "left2.C " << C << endl;;
	// 	}
	// 	offset += sizeof(int);

	// }
	// cout << "index scan count : " << mycount << endl;

	// mycount = 0;
	// while(ts->getNextTuple(data2) != QE_EOF){
	// 	mycount++;
	// 	offset = 0;
	// 	int A;
	// 	if((*(unsigned char *)((char *)data2 + offset) & (1 << 7)) == 0)
	...
	// 	offset += sizeof(int);
	// }
	// cout << "table scan count : " << mycount << endl;
